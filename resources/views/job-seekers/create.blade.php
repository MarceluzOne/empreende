...
<div class="max-w-3xl mx-auto">
    ...
    <form action="{{ route('job-seekers.store') }}" method="POST" enctype="multipart/form-data"
        x-data="{
            cpf: '{{ old('cpf', '') }}',
            phone: '{{ old('phone', '') }}',
            maskCpf(v) {
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="job_function" value="{{ old('job_function') }}"
                        placeholder="Ex: Auxiliar Administrativo, Programador..."
            ...
            <label class="flex items-center gap-4 p-4 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer
                ...
                <div>
                    <p class="font-semibold text-sm"
                        ...
                        x-text="fileName || 'Clique para anexar o currículo'"></p>
