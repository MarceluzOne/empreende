    ...
    <nav class="flex-1 px-3 py-4 overflow-y-auto space-y-0.5">
        ...
        <a href="{{ route('panel') }}"
            class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                {{ request()->routeIs('panel') ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
        ...
        <a href="{{ route('audit.index') }}"
            class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                {{ request()->routeIs('audit.*') ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
