...
<div class="max-w-3xl mx-auto">
    ...
    <form action="{{ route('job-seekers.update', $seeker) }}" method="POST"
        x-data="{
            ...
            experiences: {{ Js::from(old('experiences', $seeker->experiences ?? [])) }},
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="city" value="{{ old('city', $seeker->city) }}"
                ...
                <div>
                    ...
                    <input type="text" name="state" value="{{ old('state', $seeker->state) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="linkedin_url" value="{{ old('linkedin_url', $seeker->linkedin_url) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="github_url" value="{{ old('github_url', $seeker->github_url) }}"
                    ...
                    <div class="relative">
                        ...
                        <select name="interest_area"
                            ...
                            @foreach($interestAreas as $area)
                                <option value="{{ $area }}" {{ old('interest_area', $seeker->interest_area) === $area ? 'selected' : '' }}>{{ $area }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <select name="experience"
                            ...
                            @foreach($experienceLevels as $level)
                                <option value="{{ $level }}" {{ old('experience', $seeker->experience) === $level ? 'selected' : '' }}>{{ $level }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-3">
            ...
            <textarea name="summary" rows="4"
                placeholder="Descreva brevemente sua trajetória, principais tecnologias/habilidades e o que você busca..."
                class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none resize-none">{{ old('summary', $seeker->summary) }}</textarea>
        </div>
            ...
            <template x-for="(exp, i) in experiences" :key="i">
                <div class="border border-gray-200 rounded-xl p-4 space-y-3 bg-gray-50">
                    ...
                    <textarea :name="`experiences[${i}][activities]`" x-model="exp.activities"
                        placeholder="Atividades e conquistas..." rows="3"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-3">
            ...
            <textarea name="skills" rows="3"
                ...
                class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none resize-none">{{ old('skills', $seeker->skills) }}</textarea>
        </div>
