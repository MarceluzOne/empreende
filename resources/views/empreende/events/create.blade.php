    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data" class="p-8" @submit.prevent="validateAndSubmit($event)">
            ...
            <div class="mb-5">
                ...
                <input type="url" name="whatsapp_group_link" value="{{ old('whatsapp_group_link') }}"
                ...
                <p class="text-xs text-gray-400 mt-1">Opcional. Cole o link de convite do grupo para divulgar aos inscritos.</p>
            </div>
