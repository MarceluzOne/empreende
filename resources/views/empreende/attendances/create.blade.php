        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            <form action="{{ route('attendances.store') }}" method="POST" class="p-8 md:p-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    {{-- CNPJ (opcional) --}}
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">CNPJ
                            (Opcional)</label>
                        <input type="text" name="customer_cnpj" id="cnpj_mask" value="{{ old('customer_cnpj') }}"
