...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .auth-side{width:380px;min-width:340px;background:linear-gradient(145deg,var(--brand-deep) 0%,var(--brand) 100%);color:#fff;display:flex;flex-direction:column;justify-content:center;padding:60px 44px;position:relative;overflow:hidden}
  ...
  .auth-side h2{font-family:'Plus Jakarta Sans',sans-serif;font-size:26px;font-weight:800;line-height:1.2;margin-bottom:12px}
...
<div class="auth-wrap">
  <div class="auth-side">
    <div class="auth-side-icon"><i class="fas fa-user-plus"></i></div>
    <h2>Comece sua jornada <span>agora.</span></h2>
    <p>Crie sua conta gratuitamente e tenha acesso a eventos, cursos e vagas de emprego na cidade de Vitória de Santo Antão.</p>
  </div>
