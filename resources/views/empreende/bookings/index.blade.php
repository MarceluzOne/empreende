        ...
        <div x-show="openModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm"
            ...
            <div @click.away="openModal = false" class="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden">
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div>
                        <label class="text-xs font-bold text-gray-400 uppercase tracking-wider">Atendente Responsável</label>
                        <p class="text-gray-800 font-medium">
                            <i class="fas fa-user-tie mr-1 text-blue-900"></i>
                            <span x-text="selectedBooking.user ? selectedBooking.user.name : 'Não informado'"></span>
                        </p>
                    </div>
                ...
                <div class="p-4 bg-gray-50 flex justify-end space-x-2 border-t">
                    ...
                    <a :href="'{{ route('bookings.index') }}/' + selectedBooking.id + '/edit'"
