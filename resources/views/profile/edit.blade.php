...
@section('content')
  <div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
      ...
      <a href="{{ route('panel') }}" class="text-blue-900 hover:underline font-semibold flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
      ...
      <form action="{{ route('profile.update') }}" method="POST" class="p-8">
        ...
        <div class="mt-8 flex items-center justify-end space-x-4">
          <a href="{{ route('panel') }}" class="text-gray-600 hover:underline">Cancelar</a>
          <button type="submit"
